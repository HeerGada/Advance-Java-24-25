    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             for (int i=0;i<ck.length;i++)
            {
             ...
             out.println( "<br><a href='Page2Servlet'>Click here for page2</a><br>") ;
            out.println( "<a href='Page3Servlet'>Click here for page3</a><br>") ;
            out.println( "<a href='Page5Servlet'>Click here for page5</a><br>") ;
